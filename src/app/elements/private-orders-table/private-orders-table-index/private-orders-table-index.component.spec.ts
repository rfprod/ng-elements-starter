...
import { PrivateOrdersTableIndexComponent } from './private-orders-table-index.component';
...
describe('PrivateOrdersTableIndexComponent', () => {

  let httpController: HttpTestingController;
  let component: PrivateOrdersTableIndexComponent;
  let fixture: ComponentFixture<PrivateOrdersTableIndexComponent>;
  ...
  beforeEach(async(() => {
    ...
    .compileComponents().then(() => {
      ...
      fixture = TestBed.createComponent(PrivateOrdersTableIndexComponent);
