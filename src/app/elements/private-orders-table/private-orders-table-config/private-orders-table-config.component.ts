...
/**
 * @title Private orders table config
 */
@Component({
  selector: 'private-orders-table-config',
  template: `
...
export class PrivateOrdersTableConfigComponent {
   ...
   * Component title.
   */
  @Input() public title: string = 'Private Orders';
