...
describe('PassportSignupComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    .compileComponents().then(() => {
      ...
      fixture = TestBed.createComponent(PassportSignupComponent) as ComponentFixture<PassportSignupComponent>;
      component = fixture.componentInstance as PassportSignupComponent;
