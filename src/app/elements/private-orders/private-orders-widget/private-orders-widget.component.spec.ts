...
import { PrivateOrdersWidgetComponent } from './private-orders-widget.component';
...
describe('PrivateOrdersWidgetComponent', () => {

  let httpController: HttpTestingController;
  let component: PrivateOrdersWidgetComponent;
  let fixture: ComponentFixture<PrivateOrdersWidgetComponent>;
  ...
  beforeEach(async(() => {
    ...
    .compileComponents().then(() => {
      ...
      fixture = TestBed.createComponent(PrivateOrdersWidgetComponent);
